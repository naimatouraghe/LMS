                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                    <div className="bg-slate-100 rounded-lg p-4 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 text-sm">{inProgressCourses.length} cours</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-slate-100 rounded-lg p-4 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 text-sm">{completedCourses.length} cours</p>
                        </div>
                    </div>
                </div>
